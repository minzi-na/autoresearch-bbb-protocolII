...
def train_model(model, optimizer, train_loader, val_loader, loss_fn,
    ...
    bad = 0
    epoch_log = []
    # iter98: top-3 EMA snapshot averaging at end of training (retry iter70
    # on R-Drop stack; iter70 was -3.3e-5 close-miss without R-Drop).
    top_k_states = []
    TOP_K = 3
    ...
    for epoch in range(num_epochs):
        ...
        # iter98: track top-K EMA snapshots by candidate score.
