...
def train_model(model, optimizer, train_loader, val_loader, loss_fn,
    ...
    # iter91: EMA decay 0.9995 -> 0.999 (faster) on R-Drop stack.
    # iter17 kept 0.999 on pre-R-Drop stack. R-Drop's per-batch consistency
    # may pair better with a faster-tracking EMA snapshot.
    ema_decay = 0.999
