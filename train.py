...
class SpatialGatingUnit(nn.Module):
    ...
    # iter85: DROP_V_PATH 0.10 -> 0.05 on R-Drop stack. iter48 was close
    # without R-Drop (0.851981); R-Drop's consistency reg may unlock the
    # lower drop rate that previously plateaued.
    DROP_V_PATH = 0.05
